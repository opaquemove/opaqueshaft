    ...
    checkin : function( hm ){
        ...
        for ( var i=0; i<cpc.childNodes.length; i++ ){
            ...
            if ( c.hasAttribute('selected') ){
                ...
                // if ( oChild != null ){
                    // addChild( top + ( cursor * 20 ), left + ( cursor * 0 ), oChild.child_id, oChild.child_name, oChild.kana, oChild.child_type, oChild.child_grade, false, true );
                addChild( top + ( cursor * 20 ), left + ( cursor * 0 ), child_id, child_name, kana, child_type, child_grade, false, true );
